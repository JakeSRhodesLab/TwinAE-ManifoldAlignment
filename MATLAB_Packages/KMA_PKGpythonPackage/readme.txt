...
Verify that a Macintosh version of Python 3.9, 3.10, and/or 3.11 is installed.

2. Installing the KMA_PKG Package

A. Change to the directory that contains the file setup.py and the subdirectory KMA_PKG. 
...
In the following directions, replace MR/R2024a by the directory on the target machine where MATLAB is installed, or MR by the directory where the MATLAB Runtime is installed.
...
The KMA_PKG package is on your Python path. To import it into a Python script or session, 
execute:
