...
for column in person_1.columns:
    series = person_1[column]
    filled_series = series.interpolate(method='linear', limit_direction='both')
    person_1[column] = filled_series
    
for column in person_2.columns:
    series = person_2[column]
    filled_series = series.interpolate(method='linear', limit_direction='both')
    person_2[column] = filled_series
