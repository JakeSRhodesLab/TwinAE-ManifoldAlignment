...
tma.run_all_tests(csv_files = ["blobs", "S-curve"], test_random = 10, #General function arguments
                        split = "distort", verbose = 2, percent_of_anchors = [0.05, 0.1, 0.15, 0.2, 0.3], #Init Key arguments
