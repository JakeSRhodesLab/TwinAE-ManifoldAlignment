...
import pandas as pd
import os
#Get unique seeds so we can repeat them
...
for split_type in ["turn", "skewed", "even", "distort", "random"]:
    ...
    tma.run_all_tests(csv_files = csv_files, test_random = [1738, 7667, 2969, 9515, 1825, 3407, 3430, 5198, 5259, 2830], #General function arguments
